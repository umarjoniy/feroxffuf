        ...
        feroxbuster)
            ...
            case "${prev}" in
                ...
                -w)
                    ...
                    ;;
                --mode)
                    COMPREPLY=($(compgen -W "clusterbomb pitchfork sniper" -- "${cur}"))
                    return 0
                    ;;
                --fuzz-recurse-depth)
                    COMPREPLY=($(compgen -f "${cur}"))
